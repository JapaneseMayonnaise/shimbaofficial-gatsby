          ...
          <article>
            ...
            <div>
              <p className="is-size-5-desktop is-size-6-touch">
                Typos/comments/suggestions are welcomed on{" "}
                <a href="https://github.com/DrCardamom/shimbaofficial-gatsby/issues">
                  GitHub issues
                </a>
              </p>
              <Link to="/technicalGrowthLog/">
                <button
                  className={`button is-link is-outlined ${style.button}`}
                >
